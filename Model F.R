# ============================================================
# Model F Simulation: power under Correlated Errors
# ============================================================

setwd("C:/Users/Ke/OneDrive - Washington University in St. Louis/Desktop/python/Model22/cor_error/ModelF/")
...
write.csv(results_summary, "ModelF.csv", row.names = FALSE)
results_summary
