# ============================================================
# Model E Simulation: power under Correlated Errors
# ============================================================

setwd("C:/Users/Ke/OneDrive - Washington University in St. Louis/Desktop/python/Model22/cor_error/ModelE/")
  ...
  for (N in n_vals) {
    for (ite_method_to_use in ite_methods) {
      ...
      for (sim in 1:nrun) {
        ...
        true_groups <- as.integer(original_data$Z1 == 1)
...
write.csv(results_summary, "ModelE.csv", row.names = FALSE)
results_summary