# ============================================================
# Model C Simulation: power under Correlated Errors
# ============================================================

setwd("C:/Users/Ke/OneDrive - Washington University in St. Louis/Desktop/python/Model22/cor_error/ModelC/")
...
write.csv(results_summary, "ModelC.csv", row.names = FALSE)
results_summary
